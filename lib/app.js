...
class Application {
	...
	install() {
		...
		if( fs.existsSync( lockfilePath ) ) {
			...
			const lockInfo = PackageManagerConfiguration.fromFile( lockfilePath );
			this.config.packageManagement.locks   = lockInfo.locks;
			this.config.packageManagement.peering = lockInfo.peering;
