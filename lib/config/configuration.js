...
const PackageManagerConfiguration = require( "./packageManagerConfiguration" );
...
class Configuration {
	constructor() {
		...
		/**
		 * All options relating to the package management features.
		 * @type {PackageManagerConfiguration}
		 */
		this.packageManagement = new PackageManagerConfiguration();
